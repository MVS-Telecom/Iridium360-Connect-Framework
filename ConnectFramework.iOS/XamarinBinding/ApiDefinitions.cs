...
namespace ConnectFramework
{
	...
	[Protocol, Model (AutoGeneratedName = true)]
	[BaseType (typeof(NSObject))]
	interface R7DeviceFileTransferDelegate
	{
	...
	interface ConnectComms : ICBCentralManagerDelegate, ICBPeripheralDelegate
	{
		...
		R7DeviceFileTransferDelegate FileTransferDelegate { get; set; }
  ...
  be used.
*/[Protocol]
	interface CachedFirmwareUpdater
	{
	...
	interface FirmwareCache
	{
		...
		[Export ("update:")]
		void Update (CachedFirmwareUpdater callback);
